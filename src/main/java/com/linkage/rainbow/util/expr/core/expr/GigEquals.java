 ...
 *
 */
public class GigEquals extends Operator{
    /**
     * 
     */
    private static final long serialVersionUID = 2048380341043618397L;
    ...
    {
        if(left == null)
            throw new RuntimeException("不小于操作缺少左操作数");
        if(right == null)
            throw new RuntimeException("不小于操作缺少右操作数");
