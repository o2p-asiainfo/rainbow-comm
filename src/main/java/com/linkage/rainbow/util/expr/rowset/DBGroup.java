...
import com.linkage.rainbow.util.expr.model.PropertyDefine;
import com.linkage.rainbow.util.expr.util.Compare;
...
public class DBGroup implements Serializable, Cloneable {
     ...
     * 
     */
    private static final long serialVersionUID = -3533638413077607692L;
	// 当前分组字段名
