...
//                ".  This breaks the JavaBeans specification and can cause unpredicatble results.");
  ...
  public Method getSetter(String propertyName) {
    Method method = (Method) setMethods.get(propertyName.toUpperCase());
    if (method == null) {
  ...
  public Method getGetter(String propertyName) {
    Method method = (Method) getMethods.get(propertyName.toUpperCase());
    if (method == null) {
  ...
  public Class getSetterType(String propertyName) {
    Class clazz = (Class) setTypes.get(propertyName.toUpperCase());
    if (clazz == null) {
      throw new RuntimeException("There is no WRITEABLE property named '" + propertyName + "' in class '" + className + "'");
    }
    return clazz;
  ...
  public Class getGetterType(String propertyName) {
    Class clazz = (Class) getTypes.get(propertyName.toUpperCase());
    if (clazz == null) {
      throw new RuntimeException("There is no READABLE property named '" + propertyName + "' in class '" + className + "'");
    }
    return clazz;
  ...
  public boolean hasWritableProperty(String propertyName) {
    return setMethods.keySet().contains(propertyName.toUpperCase());
  }
  ...
  public boolean hasReadableProperty(String propertyName) {
    return getMethods.keySet().contains(propertyName.toUpperCase());
  }
